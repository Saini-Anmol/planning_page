...
duplicate rows in jkt_sim_plan_kpis / jkt_sim_plan / jkt_sim_plan_capacityUtilisation.
...
To re-run a simulation, manually clean the three sim output tables for that
...
def assert_not_already_simulated(db_cfg: dict, plan_id: str, tbl: dict) -> None:
    ...
    """
    output_tables = (tbl["plan_kpis"], tbl["plan"], tbl["capacity"])
